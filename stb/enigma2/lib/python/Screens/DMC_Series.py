...
class DMC_Series(Screen, HelpableScreen, InfoBarBase):
	...
	def __init__(self, session):
		...
		if self.serieslist.count > 0:
			...
			#	self["star" + str(i)] = LoadPixmap("/usr/lib/enigma2/python/Screens/MediaCenter/skins/defaultHD/images/Valerie_Star.png")

			#for i in range(10 - int(self.moviedb[self.serieslist[0][1]]["Popularity"])):
			#	self["star" + str(9 - i)] = LoadPixmap("/usr/lib/enigma2/python/Screens/MediaCenter/skins/defaultHD/images/Valerie_NoStar.png")
		else:
			...
			#for i in range(10):
			#	self["star" + str(i)] = LoadPixmap("/usr/lib/enigma2/python/Screens/MediaCenter/skins/defaultHD/images/Valerie_NoStar.png")
